...
def train(num_epochs):
    ...
    img_dataset_test = CustomImageDataset(train_dataset, img_dir='train_test_data/test') # Original size
    ...
    train_loader = torch.utils.data.DataLoader(img_dataset_train, batch_size=1)
    test_loader = torch.utils.data.DataLoader(img_dataset_test, batch_size=1)
